...
// Type 组件类型
func (x *Mqtt) Type() string { _ = "STUB: not implemented"; return "" }

func (x *Mqtt) New() types.Node { _ = "STUB: not implemented"; return *new(types.Node) }
...
// Destroy 销毁
func (x *Mqtt) Destroy() { _ = "STUB: not implemented"; return }

// GracefulStop provides graceful shutdown for the MQTT endpoint
// GracefulStop 为 MQTT 端点提供优雅停机
func (x *Mqtt) GracefulStop() { _ = "STUB: not implemented"; return }
...
func (x *Mqtt) Id() string { _ = "STUB: not implemented"; return "" }
...
func (x *Mqtt) Start() error { _ = "STUB: not implemented"; return nil }

// 存储路由
func (x *Mqtt) saveRouter(routers ...endpoint.Router) { _ = "STUB: not implemented"; return }
...
func (x *Mqtt) Printf(format string, v ...interface{}) { _ = "STUB: not implemented"; return }

// initClient 初始化客户端
func (x *Mqtt) initClient() (*mqtt.Client, error) { _ = "STUB: not implemented"; return nil, nil }
