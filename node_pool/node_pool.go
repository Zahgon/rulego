...
func NewNodePool(config types.Config) *NodePool { _ = "STUB: not implemented"; return nil }
...
func (n *NodePool) NewFromEndpoint(def types.EndpointDsl) (types.SharedNodeCtx, error) {
	_ = "STUB: not implemented"
	return *new(types.SharedNodeCtx), nil
}
...
func (n *NodePool) Get(id string) (types.SharedNodeCtx, bool) {
	_ = "STUB: not implemented"
	return *new(types.SharedNodeCtx), false
}
...
func (n *NodePool) Del(id string) { _ = "STUB: not implemented"; return }

// Stop stops and releases all SharedNode instances.
func (n *NodePool) Stop() { _ = "STUB: not implemented"; return }

// GetAll get all SharedNode instances
func (n *NodePool) GetAll() []types.SharedNodeCtx { _ = "STUB: not implemented"; return nil }
...
func (n *NodePool) Range(f func(key, value any) bool) { _ = "STUB: not implemented"; return }
...
func (n *sharedNodeCtx) GetNode() interface{} { _ = "STUB: not implemented"; return nil }

func (n *sharedNodeCtx) DSL() []byte { _ = "STUB: not implemented"; return nil }
...
func (n *sharedNodeCtx) SharedNode() types.SharedNode {
	_ = "STUB: not implemented"
	return *new(types.SharedNode)
}

// ReloadSelf 重写ReloadSelf方法以确保线程安全的重新加载
func (n *sharedNodeCtx) ReloadSelf(def []byte) error { _ = "STUB: not implemented"; return nil }

// 对于endpoint类型，先检查是否是DynamicEndpoint接口

// 对于RuleNodeCtx类型，已经在RuleNodeCtx.ReloadSelf中处理了线程安全

func (n *sharedNodeCtx) Destroy() { _ = "STUB: not implemented"; return }
